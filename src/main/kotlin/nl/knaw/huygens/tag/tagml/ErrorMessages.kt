...
const val UNDEFINED_RULE_ELEMENT = """Rule %s contains undefined element(s) %s."""
const val UNEXPECTED_KEY = "Unexpected key %s"
const val UNEXPECTED_CLOSE_TAG = "Unexpected closing tag: found %s, but expected <%s]"
const val UNEXPECTED_OPEN_TAG = """Unexpected opening tag: found [%s> as child of [%s>, but expected %s."""
